...
var map = {
	"./addnewcustomer/addnewcustomer.module": [
		"./src/app/addnewcustomer/addnewcustomer.module.ts",
		"addnewcustomer-addnewcustomer-module"
	],
	"./alluser/alluser.module": [
		"./src/app/alluser/alluser.module.ts",
		"common"
	],
	"./cartdetails/cartdetails.module": [
	...
	"./pricelist/addprice/addprice.module": [
		"./src/app/pricelist/addprice/addprice.module.ts",
		"common"
	],
	"./saledetails/saledetails.module": [
...
/* harmony import */ var _ionic_native_onesignal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/onesignal */ "./node_modules/@ionic-native/onesignal/index.js");
/* harmony import */ var _globals_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./globals.service */ "./src/app/globals.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, oneSignal, splashScreen, statusBar, alertCtrl, global, navCtrl, menuCtrl, router, storage, auth) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.platform.is('cordova')) {
                ...
                _this.global.onesignalID = '699af28f-ae7c-4132-9b54-8cf86d6b0c5e'; // hp septi oppo
    ...
    AppComponent.prototype.onResume = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.oneSignal.getIds().then(function (id) {
                    _this.myid = id.userId;
                    _this.global.onesignalID = id.userId;
                });
    ...
    AppComponent.prototype.gotoCartsActivity = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("carts");
    };
    AppComponent.prototype.gotoSalesActivity = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("sales");
    };
    AppComponent.prototype.gotoExpensepricelist = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("pricelist");
    };
    AppComponent.prototype.gotoEmployeeActivity = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("employee");
    };
    AppComponent.prototype.gotoCustomerActivity = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("customer");
    };
    AppComponent.prototype.gotoCustomerPayment = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("customerpayment");
    };
    AppComponent.prototype.gotoCustomerSales = function () {
        this.menuCtrl.close();
        this.navCtrl.navigateForward("customersales");
    };
    AppComponent.prototype.gotoNewCustomer = function () {
        this.menuCtrl.close();
    ...
    AppComponent.prototype.doLogout = function () {
        ...
        this.storage.remove('USER_INFO').then(function () {
            console.log(_this.global.loginloading);
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"],
            _ionic_native_onesignal__WEBPACK_IMPORTED_MODULE_5__["OneSignal"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"],
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"],
            _globals_service__WEBPACK_IMPORTED_MODULE_6__["GlobalsService"],
...
/* harmony import */ var _ionic_native_local_notifications__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/local-notifications */ "./node_modules/@ionic-native/local-notifications/index.js");
/* harmony import */ var _ionic_native_onesignal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/onesignal */ "./node_modules/@ionic-native/onesignal/index.js");
/* harmony import */ var _globals_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./globals.service */ "./src/app/globals.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_onesignal__WEBPACK_IMPORTED_MODULE_10__["OneSignal"],
                ...
                _ionic_native_local_notifications__WEBPACK_IMPORTED_MODULE_9__["LocalNotifications"],
                _globals_service__WEBPACK_IMPORTED_MODULE_11__["GlobalsService"],
                ...
                ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Config"]
            ],
...
var GlobalsService = /** @class */ (function () {
    function GlobalsService() {
        ...
        this.employeesdownloading = false;
...
var AuthGuardService = /** @class */ (function () {
    function AuthGuardService(authenticationService) {
...
/* harmony import */ var _globals_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../globals.service */ "./src/app/globals.service.ts");
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(router, storage, global, platform, toastController, http) {
        this.router = router;
        this.storage = storage;
        this.global = global;
        this.platform = platform;
    ...
    AuthenticationService.prototype.cek_token = function (whendone, whenfailed) {
        var _this = this;
        if (whenfailed === void 0) { whenfailed = null; }
        if (this.global.loginloading == false) {
            this.global.loginloading = true;
            this.storage.get('USER_INFO').then(function (response) {
                if (response) {
                    var onesignalID = _this.global.onesignalID;
                    var url = _this.global.api + 'cektoken';
                    var post = response;
                    var result = _this.http.post(url, post, {
                        responseType: 'json'
                    });
                    if (result != null) {
    ...
    AuthenticationService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            ...
            _globals_service__WEBPACK_IMPORTED_MODULE_4__["GlobalsService"],
            ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\jBrosurDroid\src\main.ts */"./src/main.ts");
