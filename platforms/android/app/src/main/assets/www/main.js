...
var map = {
	...
	"./cetaksuratjalan/cetaksuratjalan.module": [
		"./src/app/cetaksuratjalan/cetaksuratjalan.module.ts",
		"cetaksuratjalan-cetaksuratjalan-module"
	],
	"./confirmationbyemployee/confirmationbyemployee.module": [
		"./src/app/confirmationbyemployee/confirmationbyemployee.module.ts",
		"confirmationbyemployee-confirmationbyemployee-module"
	],
...
var GlobalsService = /** @class */ (function () {
    function GlobalsService() {
        ...
        this.makeDateTime = function ($input) {
            if ($input == null)
                return null;
            if ($input == 'null')
                return null;
...
module.exports = __webpack_require__(/*! c:\xampp\htdocs\jbmobile\src\main.ts */"./src/main.ts");
